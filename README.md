...
> 一个专注于渲染逻辑的库，提供 SSR、CSR、Hydration 和 SSG 功能，支持 React、Preact、Vue3 三个模板引擎

[![JSR](https://jsr.io/badges/@dreamer/render)](https://jsr.io/@dreamer/render)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](./LICENSE.md)
[![Tests](https://img.shields.io/badge/tests-231%20passed-brightgreen)](./TEST_REPORT.md)
...
- **多模板引擎支持**：支持 React、Preact、Vue3，根据项目需求选择
