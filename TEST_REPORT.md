...
- ✅ Metadata, server-data, scripts, cache, performance, compression, lazy-loading, context utils
...
All features of `@dreamer/render` pass comprehensive testing with 100% coverage. All 203 tests pass on both Deno and Bun runtimes, with support for React and Preact template engines.
